...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="<?= base_url() ?>dashboard/dash" class="brand-link">
                <i class="fas fa-shipping-fast"></i>
                <span class="brand-text font-weight-light">Inventori Peminjaman.</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url() ?>dashboard/datapeminjaman" class="nav-link">
                                ...
                                <p>
                                    Peminjaman Barang
                                    <span class="badge badge-info right"><?= $num_row ?></span>
                                </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url() ?>dashboard/datapengembalian" class="nav-link">
                                <i class="nav-icon fas fa-user-clock"></i>
                                <p>
                                    Pengembalian Barang
                                </p>
